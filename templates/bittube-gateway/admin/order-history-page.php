<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    <tr>
        <td>Exchange rate</td>
        <td>1 TUBE = <?php echo $details['rate_formatted'].' '.$details['currency']; ?></td>
    </tr>
    <tr>
        <td>Total amount</td>
        <td><?php echo $details['amount_total_formatted']; ?> TUBE</td>
    </tr>
    <tr>
        <td>Total paid</td>
        <td><?php echo $details['amount_paid_formatted']; ?> TUBE</td>
    </tr>
    <tr>
        <td>Total due</td>
        <td><?php echo $details['amount_due_formatted']; ?> TUBE</td>
    </tr>
    <tr>
        <td>Order age</td>
        <td><?php echo BitTube_Gateway::format_seconds_to_time($details['order_age']) ?> ago</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Address</td>
        <td style="word-break: break-all;"><?php echo $details['address'] ?></td>
    </tr>
</table>
...
<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    ...
    <tr>
        <td>
            <a href="<?php echo BITTUBE_GATEWAY_EXPLORER_URL.'/tx/'.$tx['txid']; ?>" target="_blank"><?php echo $tx['txid']; ?></a>
        </td>
        <td><?php echo $tx['height']; ?></td>
        <td><?php echo sprintf(BITTUBE_GATEWAY_ATOMIC_UNITS_SPRINTF, $tx['amount'] / BITTUBE_GATEWAY_ATOMIC_UNITS_POW); ?> TUBE</td>
    </tr>
    <?php endforeach; ?>
</table>
<?php endif; ?>
